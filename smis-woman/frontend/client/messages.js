...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  ClientPortal.initPage({
    activeNav: 'messages',
    title: 'Inbox',
    subtitle: 'Send private messages to administrators and view your message history.',
...
async function ensureClientInboxAccess() {
  ...
  console.log('Current User Role:', userRole, 'normalized:', lowerRole);
  ...
  if (allowedExact.includes(userRole) || allowedLower.includes(lowerRole)) {
    return true;
  }

  console.log('Redirecting because: role not allowed', { userRole, lowerRole });
  window.location.href = '/login.html';
  return false;
}
